...
namespace Parsle.SendInBlue
{
    ...
    {
        public string BaseUrl = "https://api.sendinblue.com/v2.0/";
        ...
        private async Task<dynamic> auth_call(string resource, string method, string content)
        {
            ...
            client.DefaultRequestHeaders
                  .Accept
                  .Add(new MediaTypeWithQualityHeaderValue(content_type));//ACCEPT header
            ...
            String responseString = encoding.GetString(stream.ToArray());
            if (responseString == "")
            {
        ...
        */
        public dynamic send_bat_sms(Dictionary<string, Object> data)
        {
            ...
            String phone = WebUtility.UrlEncode(mobilephone);
